...
ATLASSIAN_SELF_HOSTED_ENABLED = os.environ.get("ATLASSIAN_SELF_HOSTED_ENABLED", "false").lower() == "true"
ATLASSIAN_SELF_HOSTED_JIRA_URL=os.environ.get("ATLASSIAN_SELF_HOSTED_JIRA_URL", None)
ATLASSIAN_SELF_HOSTED_CONFLUENCE_URL=os.environ.get("ATLASSIAN_SELF_HOSTED_CONFLUENCE_URL", None)
ATLASSIAN_SELF_HOSTED_AUTH_TYPE=os.environ.get("ATLASSIAN_SELF_HOSTED_AUTH_TYPE", 'Basic')
