...
INVESTMENT_BANKER_PROMPT_SUGGESTIONS_DATA = [
    ...
    },
    {
        ...
        "prompts": [
          "Outline a pitch deck for a growth-stage SaaS company seeking Series C funding, emphasizing technology differentiators and recent market traction.",
          "Identify the most effective ways to present a technology company’s value proposition and growth story to potential investors.",
          ...
          "Draft a brief executive summary for a hypothetical high-growth tech company, focusing on its unique value proposition, recent achievements, and strategic objectives.",
    ...
    },
    {
        ...
        "content": "Market & Competitive Intelligence",
        ...
        "prompts": [
          ...
          "Identify emerging trends in technology sector deal activity over the past 12 months, and explain their impact on investment strategies.",
          ...
          "Detect emerging technology verticals or industry groups that have seen increased deal activity or client interest in recent years.",
    ...
    {
        "title": [
            "Market Positioning & Sector Trends",
            ""
        ],
